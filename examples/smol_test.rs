...
impl ContentStore for DummyCS {
    ...
    fn get<'a, 'b>(
        ...
        _name: Name<'a>,
        _can_be_prefix: bool,
        _freshness_requirement: Option<Timestamp>,
...
fn main() {
    ...
    let cs = DummyCS {};
    let platform = SmolPlatform {
        inner: Rc::new(LocalExecutor::new()),
    };
    ...
    match control_sender.send_blocking(DummyMSG::Channel(
        ...
        ChannelFaceReceiver {
            receiver: to_face_receiver,
            current_bytes: Default::default(),
        },
    )) {
        Ok(_) => {}
    ...
    match control_sender.send_blocking(DummyMSG::Channel(
        ChannelFaceSender {
            sender: to_us2_sender,
        },
        ChannelFaceReceiver {
            receiver: to_face2_receiver,
            current_bytes: Default::default(),
        },
    )) {
        Ok(_) => {}
